...
import { CreateHotel, GetHotel } from "../../Services/Hotel";
...
const EditHotel = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await GetHotel(id); // 👈 Correct method
        ...
        setFormData({
          ...
          hotelImages: [], // Only for new uploads
        });

        setImagePreviews(hotelData.hotelImages || []);
      } catch (error) {
