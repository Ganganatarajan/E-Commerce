...
const handleImageChange = (e) => {
  ...
  const availableSlots = 5 - (existingImages.length + formData.hotelImages.length);
...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    Object.entries(formData).forEach(([key, value]) => {
      if (key !== 'hotelImages' && key !== 'amenities' && value !== null && value !== undefined) {
    ...
    message.error(error.response?.data?.message || error.message || "Failed to update hotel");
  } finally {
                  ...
                  <div className="flex text-sm text-gray-600">
                    ...
                    >
                      ...
                      <input
                        ...
                        disabled={existingImages.length + formData.hotelImages.length >= 5}
                      />
                    </label>
                    <p className="pl-1">or drag and drop</p>
                  </div>
                  <p className="text-xs text-gray-500">
                    PNG, JPG, GIF up to 5MB (Total images: {existingImages.length + formData.hotelImages.length}/5)
                  </p>
                </div>
              </div>
